...
import { CreateRoutingResponseSchema, CreateRoutingSchema, FindAllRoutingResponseSchema, FindAllRoutingSchema, FindOneRoutingResponseSchema, FindOneRoutingSchema, UpdateRoutingResponseSchema, UpdateRoutingSchema } from "../schemas/routingSchemas";
...
export async function routingRoutes(app: FastifyInstance) {
    ...
    const routingController = new RoutingController(routingRepository, gatewayRepository, userRepository, caslFactory, logger);
