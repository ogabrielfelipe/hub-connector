...
import { CreateRoutingSchema, FindAllRoutingSchema, FindOneRoutingSchema, UpdateRoutingSchema } from "../schemas/routingSchemas";
...
export class RoutingController {
    ...
    constructor(
        ...
        this.createRoutingUseCase = new CreateRoutingUseCase(routingRepository, gatewayRepository, userRepository, caslAbilityFactory, logger);
        this.deleteRoutingUseCase = new DeleteRoutingUseCase(routingRepository, userRepository, caslAbilityFactory, logger);
        this.findOneRoutingUseCase = new FindOneRoutingUseCase(routingRepository, userRepository, caslAbilityFactory, logger);
        this.findAllRoutingUseCase = new FindAllRoutingUseCase(routingRepository, logger);
        this.updateRoutingUseCase = new UpdateRoutingUseCase(routingRepository, userRepository, caslAbilityFactory, logger);
    }
