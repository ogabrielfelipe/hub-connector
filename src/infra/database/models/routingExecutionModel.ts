...
const RoutingExecutionSchema = new Schema<RoutingExecutionDocument>(
    {
        ...
        status: { type: String, enum: Object.values(RoutingExecutionStatus), required: true },
        logStatus: [{
...
export const RoutingExecutionModel = model<RoutingExecutionDocument>("RoutingExecution", RoutingExecutionSchema);
