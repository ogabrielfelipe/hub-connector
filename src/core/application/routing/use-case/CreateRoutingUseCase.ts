...
export class CreateRoutingUseCase {
    ...
    constructor(routingRepository: IRoutingRepository, gatewayRepository: IGatewayRepository, userRepository: IUserRepository, abilityFactory: CaslAbilityFactory, logger: ILogger) {
